...
Additionally, I used direct back translation between English and all languages. This process generated approximately 5 samples per IPC section, resulting in a dataset of around 2,000 to 2,500 data points.

For the classification task, I applied transfer learning with the BERT-base-uncased model, utilizing it for both classification and tokenization.